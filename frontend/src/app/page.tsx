      ...
      <footer className="border-t bg-white dark:bg-[#09090b] dark:border-zinc-800">
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-2 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mt-8 space-x-6">
            <a href="https://linkedin.com" className="text-zinc-900 dark:text-zinc-100 hover:text-primary transition-colors">
            ...
            <a href="https://twitter.com" className="text-zinc-900 dark:text-zinc-100 hover:text-primary transition-colors">
            ...
            <a href="https://instagram.com" className="text-zinc-900 dark:text-zinc-100 hover:text-primary transition-colors">
