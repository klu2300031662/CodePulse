...
export default function GuestBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-amber-500/20 bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 backdrop-blur-sm mb-6">
      {/* Animated shimmer */}
      <div 
      ...
      <div className="relative flex items-center justify-between px-5 py-3.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-7 w-7 flex items-center justify-center rounded-lg text-amber-400/60 hover:text-amber-300 hover:bg-amber-500/10 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
